  ...
  return (
    ...
    >
      ...
      <main className={`px-4 max-w-7xl mx-auto relative z-10 ${activeTab === 'home' ? '-mt-10' : 'pt-20'}`}>
        ...
        {activeTab === 'home' && (
            <>  
                {/* NEW: Premium Top 10 Showcase - Right after Banner */}
                {top10Movies.length > 0 && (
                  <div className="mb-8 bg-gradient-to-br from-[#0a0a0a] to-[#111111] rounded-2xl p-5 border border-white/10 shadow-2xl">
                    <div className="flex items-center gap-3 mb-5">
                      <div className="flex items-center justify-center w-10 h-10 rounded-xl bg-gradient-to-br from-gold to-yellow-600 shadow-[0_0_20px_rgba(255,215,0,0.3)]">
                        <Award size={20} className="text-black" />
                      </div>
                      <div>
                        <h2 className="text-lg font-black text-white tracking-tight">Top 10 on CINEFLIX</h2>
                        <p className="text-[10px] text-gray-400 font-medium">Most watched this week</p>
                      </div>
                    </div>
                    
                    <div className="grid grid-cols-5 gap-2">
                      {top10Movies.slice(0, 10).map((movie, idx) => (
                        <motion.div
                          key={movie.id}
                        ...
                        >
                          ...
                          <div className="absolute -left-2 -top-2 z-20 w-8 h-8 flex items-center justify-center">
                            <span className="text-3xl font-black text-transparent bg-clip-text bg-gradient-to-br from-gold via-yellow-500 to-yellow-600" style={{
                          ...
                          {/* Movie Thumbnail */}
                          <div className="relative rounded-xl overflow-hidden border-2 border-white/10 group-hover:border-gold/50 transition-all duration-300 shadow-lg group-hover:shadow-[0_0_20px_rgba(255,215,0,0.3)]">
                            <div className="aspect-[2/3] relative">
                              ...
                              <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                                <div className="w-10 h-10 rounded-full bg-gold/90 flex items-center justify-center shadow-[0_0_20px_rgba(255,215,0,0.5)]">
